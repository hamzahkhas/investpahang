...
public class ApproveProject {
    ...
    public void testApproveProject (int fileNo) {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"sidebar\"]/div/div[2]/nav/ul/li[2]/div/ul/li[1]/div/ul/li[6]/a"))).click();
            ...
            while (!applicationFound) {
                try {
                    ...
                    WebElement noFail = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\""+ fileNo +"\"]/td[8]/div/a[4]")));
            ...
            meetingTitle.sendKeys("Meeting MMK");
            ...
            WebElement fileInput = modalContent.findElement(By.name("file_jkt"));
